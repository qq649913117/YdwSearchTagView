...
//    NSLog(@"%@",lab.text);
    if (self.delegate && [self.delegate respondsToSelector:@selector(YdwTagView:fetchWordToTextFiled:)]) {
        [self.delegate YdwTagView:self fetchWordToTextFiled:lab.text];
    }
}
